...
export default function Event(): JSX.Element {
  ...
  const fetchBlogPost = async () => {
    try {
      const response = await axios.post<any>(`https://ngo-backend-u2dt.onrender.com/getPostById/${id}`, {  
      });
        ...
        <div className="w-[80vw]  max-w-[800px] h-auto flex flex-col justify-start gap-7">
          <div className="flex flex-col gap-5">
            <div className="text-pink-600 text-[13px] font-semibold flex gap-1 items-center">
              <FaArrowLeft />
              <a onClick={() => { navigate('/blog') }} className="decoration-none text-pink-600 hover:text-pink-600 cursor-pointer">Home page</a>
            </div>
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="text-gray-900">
              <div className="text-gray-850 text-xl font-semibold font-Mont leading-[35px]" dangerouslySetInnerHTML={{ __html: post.description }}></div>
              <br />
